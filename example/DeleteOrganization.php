<?php
   ...
   * @package     DeleteOrganization.php
   * @version     1.0
   *
  +----------------------------------------------------------------------+
  ...
  +----------------------------------------------------------------------+
  $Id: DeleteOrganization.php,v 1.0 2015-02-22 14:04:18 Federico Pereira fpereira@iperfex.com Exp $ */
...
$result  = $client->call('DeleteOrganization', array('domain' => 'elastix.org') // Domain Name
