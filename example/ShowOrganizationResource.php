<?php
   ...
   * @package     ShowOrganizationResource.php
   * @version     1.0
   *
  +----------------------------------------------------------------------+
  ...
  +----------------------------------------------------------------------+
  $Id: ShowOrganizationResource.php,v 1.0 2015-02-25 20:09:18 Federico Pereira fpereira@iperfex.com Exp $ */
...
// Method 9.- ShowOrganizationResource
$result  = $client->call('ShowOrganizationResource', array('domain' => 'elastix.org') // Domain Name
...
if($see_results){
    echo "Result ShowOrganizationResource:\n";
    print_r($oResult);
}
