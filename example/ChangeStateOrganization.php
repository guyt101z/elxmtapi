<?php
   ...
   * @package     ChangeStateOrganization.php
   * @version     1.0
   *
  +----------------------------------------------------------------------+
  ...
  +----------------------------------------------------------------------+
  $Id: ChangeStateOrganization.php,v 1.0 2015-02-22 02:07:18 Federico Pereira fpereira@iperfex.com Exp $ */
...
$result  = $client->call('ChangeStateOrganization', array('domain' => 'elastix.org', // Domain Name
                                                          'state'  => 'suspend')     // Status. Argument: suspend,unsuspend,terminate
...
if($see_results){
    echo "Result ChangeStateOrganization:\n";
    print_r($oResult);
}
